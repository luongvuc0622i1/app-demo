...
public class GenerateReportController {
    ...
    public ResponseEntity<ResponseData> generateReport(@RequestBody ReqBody reqBody) {
        ResponseData responseData = employeeReportService.generateReport(reqBody.getFileName(), reqBody.getFilePath(), reqBody.getReportId());
